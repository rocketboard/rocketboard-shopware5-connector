...
class ShopInfo extends Resource
{
    /**
     ...
     * @param $id
     *
     * @return \RocketBoard\Models\ShopInfo
     *
    ...
    public function getOne($id)
    {
        ...
        $builder->where('shopinfo.id = :id')
            ->setParameter('id', $id);

        /** @var $model \RocketBoard\Models\ShopInfo */
        $model = $builder->getQuery()->getOneOrNullResult($this->getResultMode());

        if (!$model) {
            throw new ApiException\NotFoundException("ShopInfo by id $id not found");
        }
    ...
    public function create($data)
    {
        ...
        $model = new \RocketBoard\Models\ShopInfo();
    ...
    public function update($id, $data)
    {
        ...
        /** @var $model \RocketBoard\Models\ShopInfo */
        $model = $this->getManager()->find('RocketBoard\Models\ShopInfo', $id);
    ...
    protected function getBaseQuery()
    {
        ...
        $builder->select(array('shopinfo'))
            ->from('RocketBoard\Models\RocketBoard\Models\ShopInfo', 'shopinfo');
